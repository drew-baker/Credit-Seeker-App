        ...
        <div class="row" style="border-style: solid; border-width: 1px; border-radius: 7px; padding: 5px">
            ...
            <div class="container-fluid" style="border-style: solid; border-width: 1px; border-radius: 7px; padding: 5px">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="row" style="padding: 2px 5px">
                        <asp:TextBox ID="client_name" Text="Drew Baker" runat="server" /><span style="color: red">&nbsp*</span></div>
                    <div class="row" style="padding: 2px 5px">
                        <asp:TextBox ID="client_address" Text="528 W Grove St" runat="server" /><span style="color: red">&nbsp*</span></div>
                    <div class="row" style="padding: 2px 5px">
                        <asp:TextBox ID="city_label" Text="Mishawaka" runat="server" /><span style="color: red">&nbsp*</span></div>
                    <div class="row" style="padding: 2px 5px">
                        <asp:TextBox ID="state_label" Text="IN" runat="server" /><span style="color: red">&nbsp*</span></div>
                    <div class="row" style="padding: 2px 5px">
                        <asp:TextBox ID="zip_code" Text="46545" runat="server" /><span style="color: red">&nbsp*</span></div>
